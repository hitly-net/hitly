...
const features = [
  ...
  },
  {
    ...
    body: (
      <>
        Mastra, Hermes, HTTP, LangGraph, and Temporal are available today. n8n Wait is an HTTP recipe. Pause primitives stay native; <HitlyWordmark /> owns the envelope and the resume.
      </>
    ),
  },
  {
