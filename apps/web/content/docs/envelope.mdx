...
| `systemId` | Implementor | External system identifier (e.g. order service, payment gateway) |
| `inventoryId` | Implementor | Asset/resource identifier in the external system |
