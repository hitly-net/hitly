...
**Self-host** — see [Self-host](/docs/self-host). Create a project, copy `HITLY_PROJECT_ID` and an API key, then follow [Mastra](/integrations/mastra), [Hermes](/integrations/hermes), [HTTP](/integrations/http), or the [n8n Wait recipe](/integrations/n8n).
