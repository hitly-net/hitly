...
| --- | --- | --- | --- |
| `sdk` | `@hitly/core`, `@hitly/plugin-mastra`, `@hitly/plugin-n8n`, `@hitly/plugin-langgraph`, `@hitly/plugin-temporal` | Yes, later | Public Apache-2.0. Keep `private: true` until first publish. |
...
| `example` | `@hitly/example-mastra` | Never | Samples only. |
